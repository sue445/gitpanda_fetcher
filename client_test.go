...
func TestClient_FetchURL(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "Epic URL",
			args: args{
				url: "http://example.com/groups/gitlab-org/epics/1",
			},
			want: &Page{
				Title:                  "Ea cupiditate dolores ut vero consequatur quasi veniam voluptatem et non. · Epics · GitLab.org · GitLab",
				...
				FooterTitle:            "gitlab-org",
				FooterURL:              "https://gitlab.com/groups/gitlab-org",
				FooterTime:             tp(time.Date(2018, 7, 17, 13, 36, 22, 0, time.UTC)),
				Color:                  "",
			},
		},
		{
		...
		},
		{
			name: "Epic note URL",
			args: args{
				url: "http://example.com/groups/gitlab-org/epics/1#note_2",
			},
			want: &Page{
				Title:                  "Ea cupiditate dolores ut vero consequatur quasi veniam voluptatem et non. · Epics · GitLab.org · GitLab",
